...
public class ProgrammingAdapter extends RecyclerView.Adapter<ProgrammingAdapter.Viewholder> {
    ...
    public ProgrammingAdapter(ArrayList<String> heading, ArrayList<String> content, Context context) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.s_yarn_offers_card, parent, false);
